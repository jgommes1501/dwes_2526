        ...
        <legend>Formulario Editar Artículo</legend>
            ...
            <div class="mb-3">
             ...
             <div class="mb-3">
                ...
                <input type="text" class="form-control" name="marcas"  value="<?= $marcas[$articulo->marca] ?>" disabled >
            </div>

             <div class="mb-3">
                <label class="form-label fw-bold">Categorías:</label>
                <input type="text" class="form-control" name="categoria"  value="<?= implode(', ', Class_tabla_articulos::categorias_a_nombres($articulo->categorias)) ?>" disabled >
            </div>
