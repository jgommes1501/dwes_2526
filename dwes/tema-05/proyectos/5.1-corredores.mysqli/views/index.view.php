        ...
        <main>
            ...
            <div class="table-responsive">
                <table class="table table-hover">
                    ...
                    <tbody>
                        <!-- $corredores es un objeto mysqli_result, se puede usar foreach directamente  -->
                                ...
                                <td>
                                    <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                        ...
                                        <a href="delete.php?id=<?= $corredor['id'] ?>" class="btn btn-danger btn-sm" title="Eliminar"
                                            onclick="return confirm('Confimar elimación del corredor')">
                    ...
                    <tfoot>
                        <tr>
                            <td colspan="9">Total Corredores: <?= $corredores->num_rows ?></td>
                        </tr>
                    </tfoot>
                </table>
            </div>
