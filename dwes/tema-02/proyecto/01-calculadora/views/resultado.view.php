...
<head>
    ...
    <title>Proyecto 2.1 - Calculadora Básica PHP</title>
         ...
         <main>
            <form method="post"> 
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="number" class="form-control" value="<?= $valor1 ?>" step="0.01">
                </div>
              ...
              <div class="input-group mb-3">
                    ...
                    <input type="number" class="form-control" value="<?= $resultado ?>" step="0.01">
                </div>
